...
firstName = input()
if firstName < 2:
  print('Please enter your full first name...')
elif firstName > 10:
    print('Try your real name :)')
...
question1=input()
if question1 in ['Yes', 'Of course', 'I would like to']:
            ...
            print("Was she blonde or brunette?")
             personalq4=input()
              if personalq4 in ["Blonde","blonde"]:
                ...
                print("Ok, nice")
          elif personalq3 in ["No","no","not yet","Not yet","Not","not","No i do not","No i dont","no i do not","no i dont"]:
